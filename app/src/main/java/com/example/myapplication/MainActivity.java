    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Thread((new Runnable() {
            ...
            public void run() {
                ...
                fruits.add(new Fruits(29, "Mulberry", "https://images.unsplash.com/photo-1623864755317-d8c977d461f3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Calories: 329\n" + "Protein: 4.2g\n" + "Carbs: 36.9g\n" + "Sugar: 37.7g\n" + "Fiber: 5g\n" + "Fat: 1.5g\n" + "Sodium: 0.079g\n" + "Vitamin C: 33mg"));
